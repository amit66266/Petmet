    	...
    	while (rs.next()) {
    	    ...
    	    out.print(
    	        "<tr>" +
    	            ...
    	            "<td>" + city + "</td>" +
    	            "<td>" +
    	                "<button class='btn btn-primary'><a href='updaterecord.jsp?un=" + uname + "' class='text-light text-decoration-none'>Change</a></button>" +
    	            "</td>" +
    	            "<td>" +
    	                "<button class='btn btn-danger'><a href='deleterecord.jsp?un=" + uname + "' class='text-light text-decoration-none'>Delete</a></button>" +
    	            "</td>"
    	    );
    	    ...
    	    if (!"admin".equalsIgnoreCase(role)) {
    	        out.print(
    	            "<td>" +
    	                "<form action='makeadmin.jsp' method='post' onsubmit='return confirm(\"Promote " + uname + " to Admin?\");'>" +
    	        ...
    	        out.print("<td><span class='badge bg-success'>Admin</span></td>");
    	    }
