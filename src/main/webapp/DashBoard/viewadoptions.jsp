...
if (uname == null) {
    ...
    ResultSet rs = UserDAO.getAdoptedPets(uname);
%>
...
<div class="container mt-5">
    ...
    <div class="row">
        <%
            while (rs.next()) {
                int aid = rs.getInt("adoption_id");
        %>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="<%= rs.getString("image") %>" class="card-img-top" alt="Pet Image" height="250px">
                    <div class="card-body">
                        <h5 class="card-title"><%= rs.getString("name") %></h5>
                        <p class="card-text"><%= rs.getString("description") %></p>
                        <p class="card-text"><strong>Breed:</strong> <%= rs.getString("breed") %></p>
                        <p class="card-text"><strong>Age:</strong> <%= rs.getInt("age") %> yrs</p>
                        <p class="card-text"><strong>Gender:</strong> <%= rs.getString("gender") %></p>

                        <form action="deleteadoption.jsp" method="post" onsubmit="return confirm('Are you sure?');">
