...
int adoptionCount = UserDAO.getTotalAdoptionCount();
%>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item"><a class="nav-link" href="admin_adoptpet.jsp">Adopt</a></li>
        <li class="nav-item"><a class="nav-link" href="viewrecord.jsp">View Record</a></li>
...
<div class="container mt-5">
  ...
  <div class="row g-4 justify-content-center">
    <div class="col-md-4">
      <div class="card text-white bg-warning h-100 shadow">
        <div class="card-body">
          ...
          <p class="text-light">Share your experience with us.</p>
    ...
    <div class="col-md-4">
      <div class="card text-white bg-info h-100 shadow">
        <div class="card-body">
          <h5 class="card-title"><i class="fas fa-plus me-2"></i>Add New Pet</h5>
          <p>Register a pet for adoption.</p>
          <a href="addpet.jsp" class="btn btn-light mt-2">Add Now</a>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card text-white bg-primary h-100 shadow">
        <div class="card-body">
          <h5 class="card-title"><i class="fas fa-user-plus me-2"></i>Add New Customer</h5>
          <p>Register a new user account.</p>
          <a href="register.jsp" class="btn btn-light mt-2">Register</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row mt-4 justify-content-center">
    <div class="col-md-4">
      <div class="card text-white bg-success h-100 shadow text-center">
        <div class="card-body">
          <h5 class="card-title"><i class="fas fa-heart me-2"></i>Total Adoptions</h5>
          <p class="display-6 fw-bold"><%= adoptionCount %></p>
          <a href="admin_viewadoptions.jsp" class="btn btn-light mt-2">View</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="mt-5 text-center">
        <a href="admin_adoptpet.jsp" class="btn btn-outline-primary me-3"><i class="fas fa-search"></i> Browse Pets</a>
        <a href="viewrecord.jsp" class="btn btn-outline-dark"><i class="fas fa-database"></i> View Records</a>
    </div>
</div>
<footer class="py-5">
        <div class="container">
