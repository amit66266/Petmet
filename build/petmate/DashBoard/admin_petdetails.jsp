        ...
        <div class="col-md-7">
          <div class="card-body">
            ...
            <div class="mt-4 d-flex gap-2">
              <a href="updatepet.jsp?id=<%= id %>" class="btn btn-warning"><i class="fas fa-edit me-1"></i>Update</a>
              <a href="deletepet.jsp?id=<%= id %>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this pet?')">
