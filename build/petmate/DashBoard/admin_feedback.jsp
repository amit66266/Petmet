...
<%
    ...
    if (request.getParameter("deleteId") != null) {
        ...
        if (status > 0) {
            out.print("<script>alert('Feedback deleted successfully'); window.location='admin_feedback.jsp';</script>");
        } else {
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if (status > 0) {
            out.print("<script>alert('Feedback submitted successfully'); window.location='admin_feedback.jsp';</script>");
        } else {
	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="navbarNav">
	      <ul class="navbar-nav ms-auto">
	        ...
	        <li class="nav-item"><a class="nav-link active" href="admin_feedback.jsp">Feedbacks</a></li>
	        <li class="nav-item">
	          <a class="nav-link">
	          <%= 
    ...
    <div class="list-group">
        ...
        <div class="list-group-item">
            ...
            <p class="mb-1"><%= rs.getString("message") %></p>
                ...
                <form method="get" action="admin_feedback.jsp" onsubmit="return confirm('Delete this feedback?');">
