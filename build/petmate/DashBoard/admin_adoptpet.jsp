...
%>
	...
	<div class="container mt-4">
	    ...
	    <button onClick="add()" type="button" class="btn btn-outline-success" style="text-align: center;">Add Pet</button>
	    </div>
	        ...
	        <div class="col">
	            <div class="card h-100 shadow-sm">
	                ...
	                <div class="card-body">
	                    ...
	                    <a href="admin_petdetails.jsp?id=<%= id %>" class="btn btn-primary w-100">View Details</a>
	                </div>
	            </div>
	        </div>
	    <%
